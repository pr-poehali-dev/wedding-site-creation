...
const questions: Question[] = [
  {
    ...
    options: ["На вокзале", "На работе", "В университете", "Через друзей"],
    correct: 0
  },
  {
    id: 2,
    question: "Сколько лет они вместе?",
    options: ["2 года", "3 года", "3.5 года", "4 года"],
    correct: 2
  },
  {
    id: 3,
    question: "Какое любимое место для свиданий?",
    options: ["Кино", "Кафе у реки", "Качелька во дворе", "Парк"],
    correct: 2
  },
  {
    id: 4,
  ...
  },
  {
    ...
    options: ["Готовка", "Путешествия", "Рыбалка", "Фотография"],
    correct: 2
  },
  {
    id: 6,
